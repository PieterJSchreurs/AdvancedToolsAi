...
abstract class GameBoard {
    ...
    /// <summary>
    /// Returns an upper bound on the maximum number of moves
    /// (All currently implemented games are finite)
    /// </summary>
    /// <returns>The maximum number of moves.</returns>
    abstract public int MaxMoves();

    /// <summary>
    /// Returns an upper bound on the number of moves made
    /// </summary>
    /// <returns>The number of moves made.</returns>
    abstract public int MovesMade();
}
